...
// SOLUTION
// I presume we only get a string of letters as an input

// create a new reg rule to check if there is any erorr code matches

// return the result in

function printerError(s) {
  let errorString = s.match(/[n-zN-Z:]/g);
  if (errorString != null) {
